<script>
  ...
  const routes = {
    ...
    "/hello-matt": HelloMatt,
    "/all-coming-together": AllComingTogether,
    "/stylin": Stylin,
    "/nest-it": NestIt,
  ...
  <div class="container">
    <div class="left">
      ...
      <ul>
        ...
        <li>
          <a href="/all-coming-together" use:link>003 All Coming Together</a>
        </li>
        <li><a href="/stylin" use:link>004 Stylin</a></li>
